...
def shouye(starttime,endtime,passge,fail,excepthions,weizhicuowu):
    beijing='''
    <table  class="table table-hover table-condensed" style="word-wrap:break-word; word-break:break-all;">
            <tbody>
                <tr>
		...
		<td><strong>结果:</strong>
			...
			Fail: <strong >%s</strong>
			   ...
			   </div> r'''%(starttime,endtime,(endtime-starttime),passge,fail,excepthions,weizhicuowu)
    return beijing
shanghai='''<div class="row " style="margin:60px">
		...
		<tr>
            ...
            <td width="40%"><strong>实际返回</strong></td>  
